 ...
 */
@Component
public class User extends BaseSocketMessage implements BaseUser,Serializable{
	...
	public User(String clientUri, String serverUri, String userId, String userName, boolean sex, String openId, String createTime, String phoneNum, String userImg, String introduct) {
