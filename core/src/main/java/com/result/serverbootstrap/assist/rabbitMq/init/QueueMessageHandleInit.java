package com.result.serverbootstrap.assist.rabbitMq.init;
...
public class QueueMessageHandleInit {
    ...
    public QueueMessageHandleInit(ApplicationContext context) {
        Map<String, Object> taskBeanMap = context.getBeansWithAnnotation(com.result.base.annotation.Route.class);
        //2.2 遍历判断，合格的注册到map
    ...
    private boolean isHandler(Class<?> beanType) {
        return AnnotationUtils.findAnnotation(beanType, com.result.base.annotation.Route.class) != null;
    }
