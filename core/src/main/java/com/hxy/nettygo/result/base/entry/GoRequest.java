...
public class GoRequest {
    ...
    public String getSecurityCookieId() {
        ...
        if (ObjectUtil.isNotNull(request.headers().get("GoSessionId"))&&
                !request.headers().get("GoSessionId").equals("undefined")&&
                !request.headers().get("GoSessionId").equals("null")&&
                !request.headers().get("GoSessionId").equals("[object Null]"))
        {
            try {
